<%-- 
//================================================================================
//  FileName: frmDSIPersonalStaffAppFormReqEdit.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleNormalMasterPage.Master" AutoEventWireup="true" CodeBehind="frmDSIPersonalStaffAppFormReqEdit.aspx.cs" Inherits="Yaesoft.DSI.Web.frmDSIPersonalStaffAppFormReqEdit" %>
<%@ Register assembly="iPower.Web" namespace="iPower.Web.UI" tagprefix="JWC" %>
<%@ Register TagPrefix="JWC" TagName="UCStaffReq" Src="UCStaffReq.ascx" %>
<asp:Content ID="contentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
 <JWC:ValidationSummaryEx id="vsfrmDSIPersonalStaffAppFormReqEdit" runat="server"  ShowMessageBox="true" ShowSummary="false"/>
    ...
    <div class="easyui-layout" data-options="region:'center',border:false">
        <div data-options="region:'north',border:false" style="height:32px;background:#E0ECFF;">
            <div style="float:left;margin-top:2px;margin-left:10px; border:solid 0px red;">
                 ...
                 <JWC:DropDownListEx ID="ddlProject" runat="server" Width="568px" ShowUnDefine="true" IsRequired="true" ErrorMessage="申报项目名称不能为空！" />
             </div>
        </div>
