//================================================================================
//  FileName: frmDSIEduRptYearAllowanceList.aspx.cs
//  Desc:
//
//  Called by
//
...
namespace Yaesoft.DSI.Web
{
    ...
    /// 
    /// </summary>
    public partial class frmDSIEduRptYearAllowanceList : ModuleBasePage, IDSIEduRptYearAllowanceListView
    {
        #region 成员变量，构造函数。
        private DSIEduRptYearAllowancePresenter presenter;
        /// <summary>
        /// 构造函数。
        /// </summary>
        public frmDSIEduRptYearAllowanceList()
        {
            this.presenter = new DSIEduRptYearAllowancePresenter(this);
        }
        #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void dgfrmDSIEduRptYearAllowanceList_BuildDataSource(object sender, EventArgs e)
        {
            this.dgfrmDSIEduRptYearAllowanceList.DataSource = this.presenter.ListDataSource;
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            this.dgfrmDSIEduRptYearAllowanceList.InvokeBuildDataSource();
        }
        #endregion

        #region IDSIEduRptYearAllowanceListView 成员
        /// <summary>
        /// 
        /// </summary>
        public string Year
