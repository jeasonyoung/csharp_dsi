<%-- 
//================================================================================
//  FileName: frmDSIEduStaffAppFormReqList.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleFrameSetMasterPage.Master" AutoEventWireup="true" CodeBehind="frmDSIEduStaffAppFormReqList.aspx.cs" Inherits="Yaesoft.DSI.Web.frmDSIEduStaffAppFormReqList" %>
<%@ Register assembly="iPower.Web" namespace="iPower.Web.UI" tagprefix="JWC" %>
<asp:Content ID="ContentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
<JWC:ValidationSummaryEx ID="vsfrmDSIEduStaffAppFormReqList" runat="server" ShowMessageBox="true" ShowSummary="false" />
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'north',border:false" style="height:80px;">
        ...
        <div class="TitleBar">
	        <span style="float:left;">
		        <JWC:ButtonEx ID="btnAdd" runat="server" Text="申报补助" ToolTip="为离退休职工代为申报补助" PickerPage="frmDSIEduStaffAppFormReqEdit.aspx" PickerType="Modal" PickerWidth="970px" PickerHeight="680px" onclick="btnAdd_Click"/>
	        </span>
    ...
    <div data-options="region:'center',border:false">
        <!--数据显示区域-->
        <JWC:DataGridView ID="dgfrmDSIEduStaffAppFormReqList" runat="server" CssClass="DataGrid" Width="96%" ShowFooter="true"
	        AllowSorting="true" AllowPaging="true" AllowExport="true" MouseoverCssClass="DataGridHighLight"
	        PageSize="11" onbuilddatasource="dgfrmDSIEduStaffAppFormReqList_BuildDataSource">
