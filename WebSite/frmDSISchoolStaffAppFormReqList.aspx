<%-- 
//================================================================================
//  FileName: frmDSISchoolStaffAppFormReqList.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleFrameSetMasterPage.Master" AutoEventWireup="true" CodeBehind="frmDSISchoolStaffAppFormReqList.aspx.cs" Inherits="Yaesoft.DSI.Web.frmDSISchoolStaffAppFormReqList" %>
<%@ Register assembly="iPower.Web" namespace="iPower.Web.UI" tagprefix="JWC" %>
<asp:Content ID="ContentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
<JWC:ValidationSummaryEx ID="vsfrmDSISchoolStaffAppFormReqList" runat="server" ShowMessageBox="true" ShowSummary="false" />
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'north',border:false" style="height:80px;">
        ...
        <div class="TitleBar">
	        <span style="float:left;">
		        <JWC:ButtonEx ID="btnAdd" runat="server"  Text="申报补助" ToolTip="为离退休职工代为申报补助" PickerPage="frmDSISchoolStaffAppFormReqEdit.aspx" PickerType="Modal" PickerWidth="970px" PickerHeight="680px" onclick="btnAdd_Click"/>
	        </span>
    ...
    <div data-options="region:'center',border:false">
        <!--数据显示区域-->
        <JWC:DataGridView ID="dgfrmDSISchoolStaffAppFormReqList" runat="server" CssClass="DataGrid" Width="96%" ShowFooter="true"
	        AllowSorting="true" AllowPaging="true" AllowExport="true" MouseoverCssClass="DataGridHighLight"
	        PageSize="11" onbuilddatasource="dgfrmDSISchoolStaffAppFormReqList_BuildDataSource">
	        ...
	        <Columns>
		        ...
		        <JWC:MultiQueryStringFieldEx PopupWin="true" WinType="Modal" WinWidth="970px" WinHeight="680px"
			        DataNavigateUrlFormatString="frmDSISchoolStaffAppFormReqEdit.aspx?StaffID={0}&ProjectID={1}" DataNavigateUrlField="StaffID,ProjectID"
