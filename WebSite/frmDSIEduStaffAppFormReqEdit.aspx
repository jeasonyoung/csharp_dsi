<%--
//================================================================================
//  FileName: frmDSIEduStaffAppFormReqEdit.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleNormalMasterPage.Master" AutoEventWireup="true" CodeBehind="frmDSIEduStaffAppFormReqEdit.aspx.cs" Inherits="Yaesoft.DSI.Web.frmDSIEduStaffAppFormReqEdit" %>
<%@ Register assembly="iPower.Web" namespace="iPower.Web.UI" tagprefix="JWC" %>
<%@ Register TagPrefix="JWC" TagName="UCStaffReq" Src="UCStaffReq.ascx" %>
<asp:Content ID="ContentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
<JWC:ValidationSummaryEx ID="vsfrmDSIEduStaffAppFormReqEdit" runat="server" ShowMessageBox="true" ShowSummary="false" />
    ...
    <div class="easyui-layout" data-options="region:'center',border:false">
        <div data-options="region:'north',border:false" style="height:32px;background:#E0ECFF;">
            <div style="float:left;margin-top:2px;margin-left:10px; border:solid 0px red;">
                 ...
                 <JWC:DropDownListEx ID="ddlProject" runat="server" Width="468px" ShowUnDefine="true" IsRequired="true" ErrorMessage="申报项目名称不能为空！" />
            </div>
            <div style="float:left;margin-top:5px;margin-left:10px; border:solid 0px red;">
                 <JWC:LabelEx ID="lbStaffName" runat="server" Style="float:left; margin-top:7px; font-weight:bold;" meta:resourcekey="DSI_StaffName">教职工姓名：</JWC:LabelEx>
                  <JWC:PickerBase ID="pbStaff" runat="server" ToolTip="请点击输入框后的圆圈图标在弹出界面中选择职工档案！" Width="198px" MultiSelect="false" PickerPage="frmDSIStaffPicker.aspx?isAll=true" PickerWidth="460px" PickerHeight="380px" 
