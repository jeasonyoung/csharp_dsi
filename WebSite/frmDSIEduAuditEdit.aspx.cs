//================================================================================
//  FileName: frmDSIEduAuditEdit.aspx.cs
//  Desc:
//
//  Called by
//
...
namespace Yaesoft.DSI.Web
{
    ...
    /// 
    /// </summary>
    public partial class frmDSIEduAuditEdit : ModuleBasePage, IDSIEduAuditEditView
    {
        #region 成员变量，构造函数。
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.ucStaffReq.ShowMessageEvent += new ShowMessageHandler(delegate(string msg, string after)
            {
