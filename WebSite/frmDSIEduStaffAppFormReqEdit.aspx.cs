//================================================================================
//  FileName: frmDSIEduStaffAppFormReqEdit.aspx.cs
//  Desc:
//
//  Called by
//
...
namespace Yaesoft.DSI.Web
{
    ...
    /// 
    /// </summary>
    public partial class frmDSIEduStaffAppFormReqEdit : ModuleBasePage, IDSIEduStaffAppFormReqEditView
    {
        #region 成员变量，构造函数。
        ...
        /// 构造函数。
        /// </summary>
        public frmDSIEduStaffAppFormReqEdit()
        {
        ...
        #region IDSIEduStaffAppFormReqEditView 成员
        /// <summary>
        /// 
        /// </summary>
