<%-- 
//================================================================================
//  FileName: frmDSIEduRptYearAllowanceList.aspx
//  Desc:
//
//  Called by
//
...
//================================================================================
--%>
<%@ Page Language="C#" MasterPageFile="Share/ModuleFrameSetMasterPage.Master" AutoEventWireup="true" CodeBehind="frmDSIEduRptYearAllowanceList.aspx.cs" Inherits="Yaesoft.DSI.Web.frmDSIEduRptYearAllowanceList" %>
<%@ Register assembly="iPower.Web" namespace="iPower.Web.UI" tagprefix="JWC" %>
<asp:Content ID="ContentWorkPlace" ContentPlaceHolderID="workPlace" runat="server">
<JWC:ValidationSummaryEx ID="vsfrmDSIEduRptYearAllowanceList" runat="server" ShowMessageBox="true" ShowSummary="false" />
...
<div class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div data-options="region:'center',border:false">
        ...
        <!--数据显示区域-->
        <JWC:DataGridView ID="dgfrmDSIEduRptYearAllowanceList" runat="server" CssClass="DataGrid" Width="96%" ShowFooter="true"
	        AllowSorting="true" AllowPaging="true" AllowExport="true" MouseoverCssClass="DataGridHighLight"
	        PageSize="11" onbuilddatasource="dgfrmDSIEduRptYearAllowanceList_BuildDataSource">
	        ...
	        <Columns>		  
	            <JWC:BoundFieldEx DataField="CreateYear" HeaderText="年度" SortExpression="CreateYear" meta:resourcekey="DSI_DGV_CreateYear">
		         ...
		         <JWC:BoundFieldEx DataField="UnitCount" HeaderText="补助单位总数" SortExpression="UnitCount" meta:resourcekey="DSI_DGV_UnitCount">
