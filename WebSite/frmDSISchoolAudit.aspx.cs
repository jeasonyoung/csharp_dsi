//================================================================================
//  FileName: frmDSISchoolAudit.aspx.cs
//  Desc:
//
//  Called by
//
...
namespace Yaesoft.DSI.Web
{
    ...
    /// 
    /// </summary>
    public partial class frmDSISchoolAudit : ModuleBasePage, IDSISchoolAuditEditView
    {
        #region 成员变量，构造函数。
        ...
        {
            this.txtPrimaryAudit.Text = this.CurrentUserName;
            this.txtPrimaryAuditTime.Text = string.Format("{0:yyyy年MM月dd日}", DateTime.Now);
            this.presenter.LoadEntityData(new EventHandler<EntityEventArgs<DSIStaffAppFormReq>>(delegate(object sender, EntityEventArgs<DSIStaffAppFormReq> e)
            {
                ...
                {
                    this.rdPrimaryAllowance.SelectedValue = e.Entity.PrimaryAllowance.ToString();
                    this.rdAuditStatus.SelectedValue = e.Entity.Status.ToString();
                    this.txtPrimaryAudit.Text = string.IsNullOrEmpty(e.Entity.PrimaryAudit) ? this.CurrentUserName : e.Entity.PrimaryAudit;
                    this.txtPrimaryAuditTime.Text = string.Format("{0:yyyy年MM月dd日}",e.Entity.PrimaryAuditTime);
                }
            }));
        }
        #endregion
