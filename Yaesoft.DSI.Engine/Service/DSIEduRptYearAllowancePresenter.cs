//================================================================================
//  FileName: DSIEduRptYearAllowancePresenter.cs
//  Desc:
//
//  Called by
//
...
namespace Yaesoft.DSI.Engine.Service
{
    ...
    /// 
    /// </summary>
    public interface IDSIEduRptYearAllowanceListView : IModuleView
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// 
    /// </summary>
    public class DSIEduRptYearAllowancePresenter :ModulePresenter<IDSIEduRptYearAllowanceListView>
    {
        #region 成员变量，构造函数。
        ...
        public DSIEduRptYearAllowancePresenter(IDSIEduRptYearAllowanceListView view)
            : base(view)
        {
            this.View.SecurityID = ModuleConstants.Edu_Rpt_YearAllowance_ModuleID;
        ...
        public DataTable ListDataSource
        {
            get
            {
                IDSIEduRptYearAllowanceListView listView = this.View as IDSIEduRptYearAllowanceListView;
                if (listView != null)
                {
                    int unitCount = 0, count = 0;
                    float money = 0;
                    DataTable dtSource = this.staffAppFormReqEntity.EduRptYearAllowance(listView.Year, listView.ProjectID);
                    if (dtSource != null)
                    {
